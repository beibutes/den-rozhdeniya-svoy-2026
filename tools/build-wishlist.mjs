...
const CATALOG = [
  ...
  { match: ["винный", "холодильник"], id: "wine-fridge", emoji: "🍷", title: "Винный шкаф Liebherr Vinidor",
    desc: "Двухзонный, ~34 бутылки + коллекционная бутылка.",
    img: IMG("photo-1510812431401-41d2bd2722f3"), url: "https://home.liebherr.com/en/int/products/household-appliances/wine-cabinets/vinidor/vinidor.html" },
